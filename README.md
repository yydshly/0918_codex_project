...
[![AI Infra Book 完整理解图：定位、场景、模块、方法、实践与价值](projects/010-ai-infra-book/assets/understanding-map.png)](https://yydshly.github.io/0918_codex_project/010-ai-infra-book/overview.html)
...
[![《自学是门手艺》两条主线、能力、方法、范围与研究意义](projects/011-selfteaching/assets/understanding-map.png)](https://yydshly.github.io/0918_codex_project/011-selfteaching/overview.html)
...
图为独立归纳信息图，非原书插图；网页提供 46 个章节、四条路线、实践建议、成果自查和学习记录。上游 Notebook 未运行；导览与公网访问已验证。[放大总览图](https://yydshly.github.io/0918_codex_project/011-selfteaching/overview.html) · [完整文字说明](projects/011-selfteaching/notes/understanding.md) · [打开学习指南](https://yydshly.github.io/0918_codex_project/011-selfteaching/) · [运行说明](projects/011-selfteaching/demo/README.md)。

### 012 · Agent 扩展实验室

[![借助插件与 Hook 开发产品：运行扩展点、十类产品方向与开发价值](projects/012-agent-extension-lab/assets/understanding-map.png)](projects/012-agent-extension-lab/assets/understanding-map.svg)
...
1. 查看索引和 Git 历史，复制 `templates/project/` 到下一个未使用编号的子目录；当前下一编号为 `013`。
