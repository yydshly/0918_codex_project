...
for project in sorted(MANIFEST, key=lambda p: int(p['slug'].split('-')[0])):
    ...
    e = html.escape
    cards.append(f'''<article><a href="{slug}/"><img src="{slug}/{e(project['cover'])}" alt="{e(project['name'])} 能力总览" loading="lazy"></a><div><span>PROJECT {slug.split('-')[0]}</span><h2><a href="{slug}/">{e(project['name'])}</a></h2><p>{e(project['summary'])}</p><nav><a class="button" href="{slug}/">进入研究展厅 ↗</a><a href="{slug}/overview.html">一图总览</a><a href="{slug}/#compare">工具对比</a><a href="{e(project['upstream'])}">源库 ↗</a></nav></div></article>''')
